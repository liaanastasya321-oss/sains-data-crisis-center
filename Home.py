...
# --- FUNGSI AI SURAT (MODE DEMO - PASTI JALAN) ---
...
def create_pdf(no_surat, lampiran, perihal, tujuan, isi_surat):
    pdf = FPDF()
    # Margin Standar: Kiri 3cm, Atas/Kanan/Bawah 2.5cm
...
# =========================================================
# 5. HALAMAN: HOME (LAYOUT PROFESSIONAL)
# =========================================================
if selected == "Home":
...
# =========================================================
# 9. HALAMAN: SADAS BOT (SMART AI SWITCH)
# =========================================================
    ...
    if prompt := st.chat_input("Ketik pesanmu di sini..."):
        ...
        response = ""
        if "GEMINI_API_KEY" in st.secrets:
            # LOGIKA PINTAR: Coba model '1.5-flash' dulu (cepat), kalau gagal ganti 'pro'
            try:
                try:
                    # Opsi 1: Flash (Akun Baru biasanya ini)
                    ...
                    # Opsi 2: Pro (Backup untuk akun lama/region tertentu)
                ...
                response = f"🙏 Maaf, server AI sedang sibuk. Error: {str(e)}. Coba update requirements.txt"
        else:
